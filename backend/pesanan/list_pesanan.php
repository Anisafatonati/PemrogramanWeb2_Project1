            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container">
                        ...
                        <a class="btn btn-success mb-3" href="form_pesanan.php" role="button">Create pesanan</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-primary" href="delete_pesanan.php?iddel=<?= $row['id'] ?>"
                                                onclick="if(!confirm('Anda Yakin Hapus Data pesanan <?= $row['tanggal'] ?>?')) {return false}">Delete</a>
                                        </td>
                                    </tr>
                                    <?php $nomor++; } ?>
                                </tbody>
